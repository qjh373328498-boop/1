...
**核心触发词**：28 技能，~120 词，常驻内存  
**完整映射表**：按需加载（模糊匹配/触发失败/用户请求时）  
**工作流**：视频制作 (23 技能) / 内容发布 (15 技能)
...
| `skills-index.md` | 技能索引表 (88 技能) | 常驻 | ~600 | v1.1 |
| `skills-trigger-map.md` | 完整触发词映射 | 按需 | ~3,000 | v1.3 |
| `video-production-pipeline.card` | 视频工作流 (23 技能) | 按需 | - | v3.0 |
...
```
**触发词**：做个视频/生成视频/YouTube 下载/多语言视频
